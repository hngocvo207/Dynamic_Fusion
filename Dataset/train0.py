...
data_dir = f"data/preprocessed/b4e_processed_data_1"
output_dir = "./output/"
...
weighted_adj_matrix = load_data('/home/ngochv/Dynamic_Feature/data/preprocessed/b4e_processed_data_1/weighted_adjacency_matrix.pkl')
